...
import org.biu.ufo.configuration.BluetoothPreferenceManager;
...
public class SettingsActivity extends PreferenceActivity {
	...
	private final static String GENERAL_PREFERENCE = "org.biu.ufo.preferences.GENERAL";
	private final static String DEVELOPERS_PREFERENCE = "org.biu.ufo.preferences.DEVELOPERS";
	...
	private void initializeLegacyLayout() {
        ...
        if(action != null) {
            if(action.equals(DEVELOPERS_PREFERENCE)) {
                addPreferencesFromResource(R.xml.developers_preferences);
            ...
            } else if(action.equals(GENERAL_PREFERENCE)) {
