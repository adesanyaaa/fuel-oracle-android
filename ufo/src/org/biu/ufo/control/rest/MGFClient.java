...
import org.biu.ufo.control.rest.internal.mygasfeed.RequestFuelType;
import org.biu.ufo.control.rest.internal.mygasfeed.RequestSortBy;
import org.biu.ufo.control.rest.internal.mygasfeed.StationsResponse;

@EBean
public class MGFClient implements Client {
	@RestService
	org.biu.ufo.control.rest.internal.mygasfeed.Client _client;
	...
	public List<Station> getStations(String latitude, String longidute, float distance) {
		...
		for(org.biu.ufo.control.rest.internal.mygasfeed.Station mgfStation : response.stations) {
